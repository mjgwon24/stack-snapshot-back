...
이번에 스택네컷 프로젝트에 참여해보면서 그동안 혼자 끙끙대기만 했던 프로그래밍을 다른 팀원들과 같이 해보면서 깃 사용에 대한 이해도를 늘릴 수 있었고 협업이 어떤 방식으로 이루어지는지 배울 수 있었습니다. <br/>
이번 프로젝트는 짧은 시간이라면 짧다고 말 할 수 있지만 그 시간 동안 아주 많은 걸 배울수 있었고 배우는 걸 넘어 잊을 수 없는 추억이 되었습니다. <br/>
덕분에 프로그래밍하는것이 재미있다는걸 느낄 수 있었고 정말 즐거운 시간이었습니다. <br/>
다들 부족했던 절 기다려주고 도와주셔서 감사합니다. 모두 수고하셨습니다!
